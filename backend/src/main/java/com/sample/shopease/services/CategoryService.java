...
import com.sample.shopease.dto.CategoryDto;
import com.sample.shopease.dto.CategoryTypeDto;
import com.sample.shopease.entities.Category;
import com.sample.shopease.entities.CategoryType;
import com.sample.shopease.exceptions.ResourceNotFoundEx;
import com.sample.shopease.repositories.CategoryRepository;
  ...
  private Category mapToEntity(CategoryDto categoryDto){
    ...
    if(null != categoryDto.getCategoryTypeList()){
      List<CategoryType> categoryTypes =
            mapToCategoryTypesList(categoryDto.getCategoryTypeList(), category);
    ...
    if(categoryDto.getCategoryTypeList() != null){
      categoryDto.getCategoryTypeList().forEach(categoryTypeDto -> {
        if (null != categoryTypeDto.getId()){
          Optional<CategoryType> categoryType = existing.stream().filter(t -> t.getId().equals(categoryTypeDto.getId()))
                  .findFirst();
